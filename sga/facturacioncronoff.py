...
from settings import AMBIENTE_FACTURACION, EMISION_ELECTRONICA, CODIGO_INFORMACION_INSTITUTO, CODIGO_NUMERICO_ELEC, IDENTIFICACION_COMPRADOR, FACTURACION_CON_IVA, \
    ...
    INSCRIPCION_CONDUCCION, DEFAULT_PASSWORD, URL_WEBSERVICE_FIRMA, FECHA_ELECT_FAC, CENTRO_EXTERNO
...
def view(request):
        ...
        if facturaenv.mensaje != 'ERROR SECUENCIAL REGISTRADO' :
            ...
            # /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                # ///////////////////////////////////////////////////SECCION DETALLE DE FACTURA//////////////////////////////////////////////////////////////////////////////
                    ...
                    print('Error antes de entrar a firmar '+str(ex))
    ...
    for facturaenv in facturas:
        ...
        try:
            ...
            print('FOR CLAVE ACCESO REGISTRADA '+str(ex))
            ...
            if notacreditoreen.mensaje != 'CLAVE ACCESO REGISTRADA':
                if notacreditoreen.estado != 'NO ENVIADOAUT':
                    ...
                    # ///////////////////////////////////////////////////SECCION DETALLE DE FACTURA//////////////////////////////////////////////////////////////////////////////
                        ...
                        # ficheroats.write('<?xml version="1.0" encoding="UTF-8" ?>')
                        # ficheroats.write(tostring(notaCredito).decode())
                        # ficheroats.close()
...
def mail_autorizacion(correo,factura):
    ...
    if DEFAULT_PASSWORD == 'itf':
        cuerpo = 'para descargar su documento visitenos en el siguiente link http://http://sga.formacion.edu.ec/login?ret=/&fac=25 su clave es su numero de identificacion'
    elif DEFAULT_PASSWORD == 'conduccion':
    ...
    elif DEFAULT_PASSWORD == 'aok' or CENTRO_EXTERNO == True:
        cuerpo = 'para descargar su documento visitenos en el siguiente link http://sga.buckcenter.com.ec/login?ret=/&fac=25 su clave es su numero de identificacion'
    else:
