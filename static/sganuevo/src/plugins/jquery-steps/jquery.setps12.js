...
function validarDatos() {
         ...
         if (validarCedula($("#txtidentificacion").val(), $("#cmbidetificacion").val()) != 0) {
             ...
             $.post("/consultapostulacion", {
                 "action": "validaridentificacionedicion",
         ...
         if ($("#dtbfechanacimiento").val() == "") {
          ...
          if ($("#cmbcarrerainteresuno").val()==4){
             ...
             if (calcularEdad($("#dtbfechanacimiento").val())<12){
                    $("#helpdtbfechanacimiento").html("No es Mayor de 13 años");
                    cambiarTab('base-tab1', 'datospersonales');
                    return 1;
             }
