...
function validarDatos() {
         ...
         if ($("#txttelefonodomicilio").val() == "") {
             $("#helptxttelefonodomicilio").html("Debe Ingresar la nùmero de telèfono");
             cambiarTab('base-tab2', 'datoscontactos');
             return 1;
         }

         if ($("#txttelefonocelular").val() == "") {
             $("#helptxttelefonocelular").html("Debe Ingresar la nùmero de celular");
             cambiarTab('base-tab2', 'datoscontactos');
             return 1;
         }
         ...
         if ($("#cmbcarrerainteresdos").val() == "0") {
             $("#helpcmbcarrerainteresdos").html("Debe seleccionar la carrera de Interes Dos");
             cambiarTab('base-tab3', 'datosacademicos');
             return 1;
         }

         if ($("#txtnombresreferenciauno").val() == "") {
             $("#helptxtnombresreferenciauno").html("Debe ingresar los nombre y apelldios de la referencia 1");
         ...
         if ($("#txtnombresreferenciados").val() == "") {
             $("#helptxtnombresreferenciados").html("Debe ingresar los nombre y apelldios de la referencia 2");
             cambiarTab('base-tab4', 'datoreferenciapersonal');
             return 1;
         }
         ...
         if ($("#txtnombresreferenciatres").val() == "") {
             $("#helptxtnombresreferenciatres").html("Debe ingresar los nombre y apelldios de la referencia 3");
             cambiarTab('base-tab4', 'datoreferenciapersonal');
             return 1;
         }
