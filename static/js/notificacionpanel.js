...
iconoNotificacion = function(t) {
    if (t==NOTIFICACION_ALERTA) {
        return "<img src='/static/images/dalerta.png' alt='ALERTA' width='50px'/>";
    } else if (t==NOTIFICACION_ERROR) {
        return "<img src='/static/images/derror.png' alt='ERROR' width='50px'/>";
    } else if (t==NOTIFICACION_INFO) {
        return "<img src='/static/images/dinfo.png' alt='INFO' width='50px'/>";
    }
}
